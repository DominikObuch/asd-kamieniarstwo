  ...
  overwriteCurrent: function overwriteCurrent() {
    ...
    for (this.currentShown = this.lastShown; this.currentShown < this.containersEl.length + this.lastShown; this.currentShown++) {
      ...
      if (this.data[this.currentShown] !== undefined) {
        //  image changing
        this.articleEl[6][i].src = "".concat(this.imageSrc).concat(i + 1, ".jpg");
      }
      ...
      if (this.data[this.currentShown] !== undefined) {
        ...
        this.articleEl[0][i].textContent += " ".concat(this.letterNumber + (i + 1));
      }
...
document.getElementsByClassName("zoomed__image")[0].addEventListener("touchstart", function (e) {});
var startX;
var startY;
var endX;
